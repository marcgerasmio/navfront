...
function ARegisterIncubatee() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!formData.team_name || !formData.product_details || !name || !email || !password || !courseyear || !phonenumber || !selectedTbiId || !formData.logo_path) {
                ...
                <div>
                    <label htmlFor="imageUpload">
                        ...
                        <div>
                            <Image
                                ...
                                alt="Submitted"
                                roundedCircle
                                className='profile-register mb-3'
                                style={{ cursor: "pointer" }}
                            />
                            <div className='d-flex justify-content-center'>
                                <p className='title-text'>TEAM LOGO</p>
                            </div>
                        </div>
                    </label>
                    ...
                    <FloatingLabel controlId="floatingSelect" label="Select TBI Category" className='mt-3'>
                        <Form.Select aria-label="Floating label select example" name="tbi_category" onChange={handleChange}>
                            <option value="">Select TBI Category</option>
